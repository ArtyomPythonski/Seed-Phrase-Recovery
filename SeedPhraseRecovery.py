...
# Instruction Frame
instruction_frame = Frame(root, width=70, height=50, bg="#F2F2F2", highlightthickness=2, pady=20, padx=20, highlightbackground="#0081C9", highlightcolor="#0081C9")
instruction_frame.grid(row=0, column=0, pady=20, padx=20)
# Output Frame
text_output_frame = Frame(root, bg=background_color, highlightthickness=0, padx=20)
text_output_frame.grid(row=3, column=0, pady=5)

# Instructions
main_description = Label(instruction_frame,bg="#F2F2F2",fg="#0081C9",text='Input seed phrase marking with "???" the unknown words', font=("Arial", 13) )
main_description.grid(row=0, column=1)
#=======================================================================================================
# Description Label - Seed Phrase 
seed_label = Label(instruction_frame, bg="#F2F2F2", fg="#0081C9", text="Seed Phrase Pattern: ")
seed_label.grid(row=1, column=0)
# Input of unknown words
words = Entry(instruction_frame, bg="#F2F2F2", fg="#0081C9", width=70, borderwidth=1)
words.grid(row=1, column=1)
#=======================================================================================================
# Description Label - Start Address
start_address_label = Label(instruction_frame, bg="#F2F2F2", fg="#0081C9", text="Start of Address: ")
start_address_label.grid(row=2, column=0)
# Start of Address Input
start_address_entry = Entry(instruction_frame, bg="#F2F2F2", fg="#0081C9", width=70, borderwidth=2, disabledbackground="#DBDBDB")
start_address_entry.grid(row=2, column=1)
#=======================================================================================================
# Description Label - End Address
end_address_label = Label(instruction_frame, bg="#F2F2F2", fg="#0081C9", text="End of Address: ")
end_address_label.grid(row=3, column=0)
# End of Address Input
end_address_entry = Entry(instruction_frame, bg="#F2F2F2", fg="#0081C9", width=70, borderwidth=2, disabledbackground="#DBDBDB")
end_address_entry.grid(row=3, column=1)
#=======================================================================================================
# Description Label - Whole Address
whole_address_label = Label(instruction_frame, bg="#F2F2F2", fg="#0081C9", text="Whole Address: ")
whole_address_label.grid(row=4, column=0)
# Input of Whole Address
whole_address_entry = Entry(instruction_frame, bg="#F2F2F2", fg="#0081C9", width=70, borderwidth=2, disabledbackground="#DBDBDB")
...
var = IntVar()
checkbox_address = Checkbutton(instruction_frame, bg="#F2F2F2", fg="#0081C9", activebackground="#F2F2F2", activeforeground="#0081C9", highlightthickness=0, text="Whole Adress\Partial Address", variable=var, command=Checked, onvalue=1, offvalue=0, border=None)
...
text_output_label = Label(text_output_frame, bg=background_color, fg="#0081C9", text="Output:")
text_output_label.grid(row=0, column=2)
# Showing text output with the scroll function
text_frame = Frame(text_output_frame, background="yellow", width=100, height=90)
...
# Right Click menu
menu = Menu(t, tearoff=0, bg="black", fg="white")
# Options
...
# Buttons frame(copy)
buttons_frame = Frame(root, width=300, height=20, bg=background_color, highlightthickness=0, pady=5, padx=20)
...
def MyClick():
    ...
    if seed_phrase.count("???") == 1:
        comb = itertools.product(seeds, repeat=1)
        for x in comb:
    ...
    if seed_phrase.count("???") == 2:
        comb = itertools.product(seeds, repeat=2)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
    ...
    if seed_phrase.count("???") == 3:
        comb = itertools.product(seeds, repeat=3)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
    ...
    if seed_phrase.count("???") == 4:
        comb = itertools.product(seeds, repeat=4)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 5:
        comb = itertools.product(seeds, repeat=5)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 6:
        comb = itertools.product(seeds, repeat=6)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 7:
        comb = itertools.product(seeds, repeat=7)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 8:
        comb = itertools.product(seeds, repeat=8)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 9:
        comb = itertools.product(seeds, repeat=9)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 10:
        comb = itertools.product(seeds, repeat=10)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 11:
        comb = itertools.product(seeds, repeat=11)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
    ...
    if seed_phrase.count("???") == 12:
        comb = itertools.product(seeds, repeat=12)
        for x in comb:
            seed1 = seed_phrase.replace("???", str(x[0]), 1)
            seed2 = seed1.replace("???", str(x[1]), 1)
            seed3 = seed2.replace("???", str(x[2]), 1)
...
# Clear Button
clear_button = Button(instruction_frame, bg="#F2F2F2", fg="#0081C9", activebackground=background_color, activeforeground="#0081C9", text="clear", command=delete)
